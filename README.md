...
- **Cloud migration** of a complex PHP/WordPress + PHP/Eloquent/MySQL monolith from bare metal to AWS for an EU automotive leasing client — component-by-component cutover to EC2, then to cloud-native services (RDS with Performance Insights, CloudFront, Route53).
